...
% Set english(other options are sami and nor) and masterthesis profile(replace master with phd to use phd profile)
\documentclass[eng, phd]{../../texmf-tds/tex/latex/uit-thesis/uit-thesis}
