\documentclass[baselinegrid,noprint,nocopyright]{uit-thesis}
...
% Section name that will span two lines, only if hanging indent is included.
% Makes sure calculation of num. lines is correct.
